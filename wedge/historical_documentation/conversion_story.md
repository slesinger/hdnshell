...
This file retells the story from `wedge-analysis.md` in chronological order. It keeps the technical details, but the narrative is reorganized to follow how the work actually evolved over time.
