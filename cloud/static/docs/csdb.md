...
Some downloads on CSDB require being logged in. You can optionally enter your CSDB username and password in the server web UI `Settings` (under the **Apps & Services** tab, **CSDB.dk** section), and the server will use them when fetching files.
