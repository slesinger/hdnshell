...
HELP_LINES = [
    ...
    " 1. Go to my.telegram.org and",
    "    sign in with your Telegram",
    "    phone number (+country code).",
    " 2. A code is sent to your",
    "    Telegram app (not SMS).",
    "    Enter it on the website.",
    " 3. Click 'API development tools'.",
    " 4. Click 'Create new application'.",
    "    Fill in app title, short name,",
    "    and platform. Click Create.",
    " 5. Copy the App api_id and",
    "    App api_hash shown on screen",
    "    and paste them in Settings.",
    "",
    " LOGIN FLOW",
    " 1. Enter phone with country code",
    "    (e.g. +1234567890). RETURN.",
    " 2. Enter the code Telegram sends",
    "    to your Telegram app. RETURN.",
    " 3. If 2FA is on, enter your cloud",
    "    password. RETURN.",
    "",
    " ABOUT THE 2FA PASSWORD",
    " This is a static password YOU",
    " set in Telegram settings, not a",
    " code sent to your phone. Find it:",
    ...
    "  Telegram requires a 7-day wait",
    "  before allowing a reset.",
    "",
