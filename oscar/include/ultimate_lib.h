...
void uii_identify(void);  // output uui_data is null-string like "ultimate-ii dos v1.2"
...
void uii_getipaddress(void);  // output uui_data is fixed like "ipipipipnmnmnmnmgwgwgwgw
...
void uii_get_time(void);  // output uui_data is null-string like " 2024/12/31 23:59:59"
